...
Page({
    ...
    controls: [
      {
        ...
        iconPath: "../../assets/icons/circle1.png",
        clickable: true
      }
    ]
  },
  ...
  changeMarkerColor(markerId) {
    ...
    markers.forEach((item, index) => {
      item.iconPath = "../../assets/icons/marker.png";
      if (index == markerId) item.iconPath = "../../assets/icons/marker_checked.png";
    })
  ...
  getRoute() {
    ...
    let url = `/pages/route/route?longitude=${longitude}&latitude=${latitude}&longitude2=${longitude2}&latitude2=${latitude2}&city=${city}&name=${name}&desc=${desc}`;
    wx.navigateTo({ url });
  },
  clickcontrol(e) {
